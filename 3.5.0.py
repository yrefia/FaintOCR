...
# 3.5.0: 统一“生成匹配数据”按钮边框与可用/不可用文字色，并直接显示字典状态文案。
...
class I18n:
    ...
    TEXT = {
        "zh_CN": {
            ...
            "ui_status_connected": "FaintOCR 3.5.0 已连接 OCR 控制器",
            ...
            "log_cleanup": "FaintOCR 3.5.0 资源清理完成",
        ...
        "en_US": {
            ...
            "ui_status_connected": "FaintOCR 3.5.0 connected to OCR controller",
            ...
            "log_cleanup": "FaintOCR 3.5.0 resources cleaned up",
