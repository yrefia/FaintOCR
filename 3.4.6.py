...
class I18n:
    ...
    TEXT = {
        "zh_CN": {
            ...
            "ui_status_connected": "FaintOCR 3.4.6 已连接 OCR 控制器",
            ...
            "log_cleanup": "FaintOCR 3.4.6 资源清理完成",
        ...
        "en_US": {
            ...
            "ui_status_connected": "FaintOCR 3.4.6 connected to OCR controller",
            ...
            "log_cleanup": "FaintOCR 3.4.6 resources cleaned up",
    ...
    def _match_prefix_by_length(self, ocr_text, similarity_threshold):
        ...
        if target_len not in self.len_cache:
            ...
            self.len_cache[target_len] = {
                'data': [candidate[:target_len + 1] for candidate in self.candidates_full],
                'score': 0.0,
