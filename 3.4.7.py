...
class I18n:
    ...
    TEXT = {
        "zh_CN": {
            ...
            "ui_status_connected": "FaintOCR 3.4.7 已连接 OCR 控制器",
            ...
            "log_cleanup": "FaintOCR 3.4.7 资源清理完成",
        ...
        "en_US": {
            ...
            "ui_status_connected": "FaintOCR 3.4.7 connected to OCR controller",
            ...
            "log_cleanup": "FaintOCR 3.4.7 resources cleaned up",
...
class SettingsWindow(SoftWidget):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton#generateButton[generateState="off"],
            QPushButton#generateButton[generateState="off"]:disabled {
                background: #252936; border-color: #363b4c; color: #d5d7e2;
                font-weight: 600;
            }
            QPushButton#generateButton[generateState="loading"],
            QPushButton#generateButton[generateState="loading"]:disabled {
                background: #332b1f; border-color: #8c7439; color: #e0c979;
                font-weight: 600;
            }
            QPushButton#generateButton[generateState="missing"],
            QPushButton#generateButton[generateState="missing"]:hover {
                background: #341f26; border-color: #8e4654; color: #ef9aa9;
                font-weight: 600;
            }
            QPushButton#generateButton[generateState="ready"],
            QPushButton#generateButton[generateState="ready"]:hover,
            QPushButton#generateButton[generateState="ready"]:disabled {
                background: #1c2824; border-color: #3f6b59; color: #83b99e;
                font-weight: 600;
            }
    ...
    def set_generate_state(self, state):
        if state not in {"off", "loading", "missing", "ready"}:
            state = "loading"
    ...
    def _refresh_match_interaction(self):
        ...
        text_key = {
            "loading": "ui_match_data_loading",
            "missing": "ui_match_data_missing",
            "ready": "ui_match_data_ready",
        }.get(state, "ui_generate_match_data")
        button_text = I18n.get(text_key)
...
class FaintOCRApplication(QtCore.QObject):
    ...
    def handle_dict_state(self, state, data_list, current_level, target_level):
        ...
        self.settings.set_generate_state(generate_state)
